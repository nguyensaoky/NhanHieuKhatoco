...
//==================================================================================================
//==================================================================================================
TransMenu.spacerGif = "/x.gif";                     // path to a transparent spacer gif
TransMenu.dingbatOn = "/arrow-on.gif";            // path to the active sub menu dingbat
TransMenu.dingbatOff = "/arrow-off.gif";          // path to the inactive sub menu dingbat
TransMenu.dingbatSize = 7;                            // size of the dingbat (square shape assumed)
...
//TransMenu.backgroundColor = "#1C351C";                   // color of the background (transparency set in CSS)
TransMenu.backgroundColor = "#0000FF";

					...
					<tr valign="top">
						...
						<td>
							<table summary="Tabs Design Table">
								...
								<tr>
									<td valign="top" style="width: 10%;">
										<asp:imagebutton id="cmdDelete" resourcekey="cmdDelete.Help" runat="server" alternatetext="Delete Tab" imageurl="~/images/delete.gif" OnClick="cmdDelete_Click"></asp:imagebutton>
									</td>
									<td valign="top" style="width: 90%;">
									</td>
								</tr>

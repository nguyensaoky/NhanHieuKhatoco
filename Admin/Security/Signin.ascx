...
<asp:panel id="pnlLogin" runat="server">
	<table cellspacing="0" cellpadding="3" border="0" summary="SignIn Design Table" width="160">
		...
		<tr>
			<td id="tdLogin" runat="server" width="50%" align="center"><asp:button id="cmdLogin" resourcekey="cmdLogin" cssclass="StandardButton" text="Login" runat="server" width="100%" OnClick="cmdLogin_Click" /></td>
			<td id="tdRegister" runat="server" width="50%" align="center"><asp:button id="cmdRegister" resourcekey="cmdRegister" cssclass="StandardButton" text="Register" runat="server" width="100%" OnClick="cmdRegister_Click" /></td>
		</tr>
...
<asp:panel id="pnlPassword" runat="server" visible="false">
	<dnn:Password id="ctlPassword" runat="server" OnPasswordUpdated="PasswordUpdated"></dnn:Password>

<%@ Control Language="C#" AutoEventWireup="true"  Inherits="DotNetNuke.Modules.Admin.Security.EditRoles" CodeFile="EditRoles.ascx.cs" %>
...
<p>
	<asp:linkbutton id="cmdUpdate" resourcekey="cmdUpdate" runat="server" cssclass="CommandButton" text="Update" borderstyle="none" OnClick="cmdUpdate_Click" />
	&nbsp;
	<asp:linkbutton id="cmdCancel" resourcekey="cmdCancel" runat="server" cssclass="CommandButton" text="Cancel" causesvalidation="False" borderstyle="none" OnClick="cmdCancel_Click" />
	&nbsp;
	<asp:linkbutton id="cmdDelete" resourcekey="cmdDelete" runat="server" cssclass="CommandButton" text="Delete" causesvalidation="False" borderstyle="none" OnClick="cmdDelete_Click" />
	&nbsp;
	<asp:linkbutton id="cmdManage" resourcekey="cmdManage" runat="server" cssclass="CommandButton" text="Manage Users" causesvalidation="False" OnClick="cmdManage_Click" />
</p>

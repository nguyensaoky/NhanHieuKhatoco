<%@ Control Language="C#" CodeFile="MemberServices.ascx.cs" AutoEventWireup="true"  Inherits="DotNetNuke.Modules.Admin.Security.MemberServices" %>
...
<table id="tblServices" cellspacing="0" cellpadding="4" width="600" summary="Register Design Table" border="0" runat="server">
	<tr>
		...
		<td width="325"><asp:textbox id="txtRSVPCode" runat="server" width="100" cssclass="NormalTextBox" maxlength="50" columns="30"></asp:textbox><asp:linkbutton class="CommandButton" id="cmdRSVP" runat="server" text="Subscribe" resourcekey="cmdRSVP" OnClick="cmdRSVP_Click"></asp:linkbutton></td></tr>
	<tr>
		<td colspan="2">

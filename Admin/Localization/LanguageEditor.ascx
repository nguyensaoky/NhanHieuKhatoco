...
<table id="Table2" border="0" cellspacing="5" width="100%">
    <tr>
        <td nowrap="nowrap" valign="top">
            <p>
                <asp:Panel ID="Panel1" runat="server" Width="195px">
                    <dnntv:DnnTree ID="DNNTree" runat="server" CssClass="Normal" DefaultNodeCssClass="Normal" DefaultNodeCssClassOver="Normal" OnNodeClick="DNNTree_NodeClick">
                    </dnntv:DnnTree>
                </asp:Panel>
            </p>
        </td>
        <td valign="top">
            ...
            <p>
                <asp:DataGrid ID="dgEditor" runat="server" AutoGenerateColumns="False" CellPadding="3" CssClass="Normal" GridLines="None" OnItemDataBound="dgEditor_ItemDataBound">

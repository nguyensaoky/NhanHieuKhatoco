                        ...
                        <td valign="top" style="width: 475;">
                            ...
                            <table id="tblOther" runat="server" border="0" cellpadding="2" cellspacing="2" summary="Other Setttings Design Table">
                                <tr>
                                    ...
                                    <td class="NormalTextBox" style="width: 325;">
                                        <asp:TextBox ID="txtFooterText" runat="server" CssClass="NormalTextBox" TextMode="MultiLine" Rows=5 MaxLength="10000" Width="300"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <dnn:Label ID="lblGoogleMapKey" runat="server" ControlName="txtGoogleMapKey" Text="Google map key" />
                                    </td>
                                    <td style="width: 325;">
                                        <asp:TextBox ID="txtGoogleMapKey" runat="server" CssClass="NormalTextBox" Width="300"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <dnn:Label ID="lblMailServer" runat="server" ControlName="txtMailServer" Text="Mail server:" />
                                    </td>
                                    <td style="width: 325;">
                                        <asp:TextBox ID="txtMailServer" runat="server" CssClass="NormalTextBox" Width="300"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <dnn:Label ID="lblMailAccount" runat="server" ControlName="txtMailAccount" Text="Mail account:" />
                                    </td>
                                    <td style="width: 325;">
                                        <asp:TextBox ID="txtMailAccount" runat="server" CssClass="NormalTextBox" Width="300"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <dnn:Label ID="lblMailPassword" runat="server" ControlName="txtMailPassword" Text="Mail password:" />
                                    </td>
                                    <td style="width: 325;">
                                        <asp:TextBox ID="txtMailPassword" runat="server" CssClass="NormalTextBox" Width="300" TextMode="Password"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                            <br/>

<%@ Control Language="C#" AutoEventWireup="true"  Inherits="DotNetNuke.Modules.Admin.Sales.Purchase" CodeFile="Purchase.ascx.cs" %>
<br>
...
<p>
	...
	<asp:linkbutton class="CommandButton" id="cmdPurchase" runat="server" BorderStyle="none" Text="Update" OnClick="PurchaseBtn_Click">Purchase</asp:linkbutton>&nbsp;
	<asp:linkbutton class="CommandButton" id="cmdCancel" runat="server" BorderStyle="none" Text="Cancel" CausesValidation="False" OnClick="cmdCancel_Click"></asp:linkbutton>
</p>

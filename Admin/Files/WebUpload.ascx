        ...
        <td valign="top" width="560">
            <asp:Panel ID="pnlUpload" Visible="True" CssClass="WorkPanel" runat="server">
                <table class="Settings" id="tblUpload" cellspacing="2" cellpadding="2"
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            ...
                            <asp:LinkButton ID="cmdAdd" runat="server" CssClass="CommandButton" Resourcekey="cmdUpload" OnClick="cmdAdd_Click">Add</asp:LinkButton>
                        </td>
                    </tr>
                ...
                <table id="tblLogs" cellspacing="0" cellpadding="0" summary="Resource Upload Logs Table"
                    ...
                    <tr>
                        <td>
                            <asp:LinkButton ID="cmdReturn1" runat="server" CssClass="CommandButton" resourcekey="cmdReturn" OnClick="cmdReturn_Click">Return to File Manager</asp:LinkButton></td>
                    </tr>
                    <tr>
                        <td>
                            &nbsp;</td>
                    ...
                    <tr>
                        <td>
                            <asp:LinkButton ID="cmdReturn2" runat="server" CssClass="CommandButton" resourcekey="cmdReturn" OnClick="cmdReturn_Click">Return to File Manager</asp:LinkButton></td>
                    </tr>
                </table>
            </asp:Panel>
        </td>

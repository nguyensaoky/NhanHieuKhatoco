					...
					<td id="tdGrid" vAlign="top" width="100%"><asp:datagrid id="dgFileList" runat="server" Width="100%" GridlInes="Horizontal" AllowPaging="True"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderStyle-HorizontalAlign="Left" SortExpression="FileName" HeaderText="FileName">
									<ItemTemplate>
                                        <asp:HyperLink CssClass="Normal" runat="server" NavigateUrl='<%# DotNetNuke.Common.Globals.LinkClick(FileSystemUtils.StripFolderPath( DestPath ).Replace( "\\", "/" ) + DataBinder.Eval(Container, "DataItem.FileName"), TabId, ModuleId)%>'><%# DataBinder.Eval(Container, "DataItem.FileName")%></asp:HyperLink>
									</ItemTemplate>
									<EditItemTemplate>

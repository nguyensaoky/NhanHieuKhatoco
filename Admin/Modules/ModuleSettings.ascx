...
<%@ Control Language="C#" AutoEventWireup="true"  Inherits="DotNetNuke.Modules.Admin.Modules.ModuleSettingsPage" CodeFile="ModuleSettings.ascx.cs" %>
				...
				<tr>
					...
					<td valign="top" style="width: 475;">
						...
						<table id="tblDetails" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" style="width: 200;"><dnn:label id="plTitle" text="Title:" runat="server" controlname="txtTitle"></dnn:label></td>
						...
						<table id="tblSecurity" cellspacing="2" cellpadding="2" summary="Security Details Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" style="width: 225;"><dnn:label id="plAllTabs" text="Display Module On All Pages?" runat="server" controlname="chkAllTabs"></dnn:label></td>
								<td><asp:checkbox id="chkAllTabs" runat="server" font-size="8pt" font-names="Verdana,Arial"></asp:checkbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 225;"><dnn:label id="plHeader" text="Header:" runat="server" controlname="txtHeader"></dnn:label></td>
							...
							<tr>
								<td class="SubHead" style="width: 225;"><dnn:label id="plFooter" text="Footer:" runat="server" controlname="txtFooter"></dnn:label></td>
								<td valign="top"><asp:textbox id="txtFooter" width="250" cssclass="NormalTextBox" runat="server" textmode="MultiLine"
										rows="6"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;" valign="top"><dnn:label id="plStartDate" runat="server" controlname="txtStartDate" text="Start Date:"></dnn:label></td>
								<td>
							...
							<tr>
								<td class="SubHead" style="width: 150;" valign="top"><dnn:label id="plEndDate" runat="server" controlname="txtEndDate" text="End Date:"></dnn:label></td>
								<td>
				...
				<tr>
					...
					<td valign="top" style="width: 475;">
						...
						<table id="tblAppearance" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
							...
							<tr>
								<td class="SubHead" style="width: 200;"><dnn:label id="plAlign" text="Alignment:" runat="server" controlname="cboAlign"></dnn:label></td>
								<td valign="top">
							...
							<tr>
								<td class="SubHead" style="width: 200;"><dnn:label id="plColor" text="Color:" runat="server" controlname="txtColor"></dnn:label></td>
								<td valign="top"><asp:textbox id="txtColor" width="250" cssclass="NormalTextBox" runat="server" columns="7"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 200;"><dnn:label id="plBorder" text="Border:" runat="server" controlname="txtBorder"></dnn:label></td>
								<td valign="top">
							...
							<tr>
								<td class="SubHead" style="width: 200;"><dnn:label id="plVisibility" text="Visibility:" runat="server" controlname="cboVisibility"></dnn:label></td>
								<td>
							...
							<tr>
								<td class="SubHead" style="width: 200;"><dnn:label id="plDisplayTitle" text="Display Title?" runat="server" controlname="chkDisplayTitle"></dnn:label></td>
								<td valign="top"><asp:CheckBox ID="chkDisplayTitle" Runat="server" CssClass="NormalTextBox"></asp:CheckBox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 200;"><dnn:label id="plDisplayPrint" text="Allow Print?" runat="server" controlname="chkDisplayPrint"></dnn:label></td>
								<td valign="top"><asp:CheckBox ID="chkDisplayPrint" Runat="server" CssClass="NormalTextBox"></asp:CheckBox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 200;"><dnn:label id="plDisplaySyndicate" text="Allow Syndicate?" runat="server" controlname="chkDisplaySyndicate"></dnn:label></td>
								<td valign="top"><asp:CheckBox ID="chkDisplaySyndicate" Runat="server" CssClass="NormalTextBox"></asp:CheckBox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 200;"><dnn:label id="plModuleContainer" text="Module Container:" runat="server" controlname="ctlModuleContainer"></dnn:label></td>
								<td valign="top"><dnn:skin id="ctlModuleContainer" runat="server"></dnn:skin></td>
							</tr>
							<tr id="rowCache" runat="Server">
								<td class="SubHead" style="width: 200;" valign="top"><dnn:label id="plCacheTime" runat="server" controlname="txtCacheTime" text="Cache Timeout (seconds):"></dnn:label></td>
								<td>
						...
						<table id="tblOther" cellspacing="2" cellpadding="2" summary="Security Details Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" style="width: 200;"><dnn:label id="plDefault" text="Set As Default Settings?" runat="server" controlname="chkDefault"></dnn:label></td>
								<td valign="top"><asp:CheckBox ID="chkDefault" Runat="server" CssClass="NormalTextBox"></asp:CheckBox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 200;"><dnn:label id="plAllModules" text="Apply To All Modules?" runat="server" controlname="chkAllModules"></dnn:label></td>
								<td valign="top"><asp:CheckBox ID="chkAllModules" Runat="server" CssClass="NormalTextBox"></asp:CheckBox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 200;"><dnn:label id="plTab" text="Move To Tab:" runat="server" controlname="cboTab"></dnn:label></td>

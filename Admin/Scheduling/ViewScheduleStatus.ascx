...
<table border="0" cellspacing="1" cellpadding="3">
	...
	<tr>
		...
		<td class="Normal">
			<asp:linkbutton id="cmdStart" resourcekey="cmdStart" cssclass="CommandButton" runat="server" OnClick="cmdStart_Click">Start</asp:linkbutton>
			&nbsp;&nbsp;
			<asp:linkbutton id="cmdStop" resourcekey="cmdStop" cssclass="CommandButton" runat="server" OnClick="cmdStop_Click">Stop</asp:linkbutton>
		</td>
	</tr>
</table>
<br>

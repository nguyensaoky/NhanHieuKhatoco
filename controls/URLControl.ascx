...
<table border="0" cellpadding="0" cellspacing="0">
    ...
    <tr id="FileRow" runat="server">
        <td nowrap="nowrap">
            <asp:Label ID="lblFolder" runat="server" CssClass="NormalBold" EnableViewState="False" resourcekey="Folder"></asp:Label>
            <asp:DropDownList ID="cboFolders" runat="server" AutoPostBack="True" CssClass="NormalTextBox" Width="300"></asp:DropDownList>
            <asp:Image ID="imgStorageLocationType" runat="server" Visible="False" /><br>
            <asp:Label ID="lblFile" runat="server" CssClass="NormalBold" EnableViewState="False" resourcekey="File"></asp:Label>
            <asp:DropDownList ID="cboFiles" runat="server" CssClass="NormalTextBox" DataTextField="Text" DataValueField="Value" Width="300"></asp:DropDownList>
            <input id="txtFile" runat="server" name="txtFile" size="30" type="file" width="300">
            <br>
            <asp:LinkButton ID="cmdUpload" runat="server" CausesValidation="False" CssClass="CommandButton" resourcekey="Upload">Upload</asp:LinkButton>
            ...
            <asp:LinkButton ID="cmdCancel" runat="server" CausesValidation="False" CssClass="CommandButton" resourcekey="Cancel">Cancel</asp:LinkButton>
        </td>
    </tr>

...
function AVIM()	{
	...
	if(AVIMGlobalConfig.showControl) {
		...
		document.write('<input type="checkbox" id="avim_daucu" onclick="AVIMObj.setDauCu(this);" />Kiểu cũ<br />');
		document.write('<a class="AVIMControl" onclick="document.getElementById(' + "'AVIMControl').style.display='none';" + '">[Ẩn AVIM - F12]</a></p>');
		document.write('</span>');
	}

...
{
    public partial class nhanhieu_edit : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        int ID = 0;
        ...
        private void LoadData()
        {
            ...
            { 
                ...
                hdBienDongID.Value = r["BienDongID"] == DBNull.Value ? "0" : Convert.ToInt16(r["BienDongID"]).ToString();
        ...
        public string SaveFile(string FolderUpload, out string FullFileName)
        {
            FullFileName = "";
            ...
            if (lblMessage.Text == String.Empty)
            {
                ...
                FileInfo file = fileCont.GetFile(FullFileName, PortalId, FolderUpload);

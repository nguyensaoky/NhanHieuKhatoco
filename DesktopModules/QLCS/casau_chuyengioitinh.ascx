<%@ Control Language="C#" AutoEventWireup="true" CodeFile="casau_chuyengioitinh.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.casau_chuyengioitinh" %>
...
<div id="wrapper" runat="server" class="wrapper_margin">
    <div style="width:200px;float:left;">Giới tính mới</div>
    ...
    <asp:GridView ID="grvDanhSach" runat="server" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="NoteVal" HeaderText="Giới tính mới" SortExpression="[NoteVal] DESC">
                <HeaderStyle ForeColor="Yellow"></HeaderStyle>
            </asp:BoundField>
            <asp:TemplateField>
                <HeaderTemplate>

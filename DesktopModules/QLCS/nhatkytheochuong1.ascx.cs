...
{
    public partial class nhatkytheochuong1 : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "NKC";
                string tieude = "";
                string strSQL = "QLCS_BCTK_NhatKy_TheoChuong_1_new";
                if (ddlChuan.SelectedValue == "1")
                {
                    strSQL = "QLCS_BCTK_NhatKy_TheoChuong_1_new_ChuanCu";
                }
                ...
                param[0] = new SqlParameter("@StrChuong", sChuong);
                ...
                tieude += "<b>NHẬT KÝ CHĂN NUÔI THEO Ô CHUỒNG - TỪ NGÀY " + txtTuNgay.Text + "  ĐẾN NGÀY " + txtDenNgay.Text + "</b>";

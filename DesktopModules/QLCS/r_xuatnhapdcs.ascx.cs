...
{
    public partial class r_xuatnhapdcs : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                param[2] = new SqlParameter("@LoaiVatTu", "DCS");
                filename += txtFromDate.Text + "___" + txtToDate.Text + ".xls";
                filename = filename.Replace("/", "_");
                tieude += "<b>BẢNG THEO DÕI XUẤT, NHẬP DA CÁ SẤU MUỐI TỪ NGÀY " + txtFromDate.Text + " ĐẾN NGÀY " + txtToDate.Text + "</b>";

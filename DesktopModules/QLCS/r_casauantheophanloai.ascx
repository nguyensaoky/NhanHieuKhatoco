<%@ Control Language="C#" AutoEventWireup="true" CodeFile="r_casauantheophanloai.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.r_casauantheophanloai" %>
...
<table>
    <tr><td><center><b>CÁ ĂN THEO GIỐNG - TĂNG TRỌNG</b></center><br /></td></tr>
    <tr>
        <td>

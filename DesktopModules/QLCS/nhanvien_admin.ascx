<%@ Control Language="C#" AutoEventWireup="true" CodeFile="nhanvien_admin.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.nhanvien_admin" %>
...
<div align="left">
    ...
    <asp:HyperLink ID="lnkAddNew" runat="server" Text="Thêm nhân viên mới" CssClass="button"></asp:HyperLink>
</div>
<div style="width:100%;">
    <asp:GridView ID="grvDanhSach" runat="server"
        ...
        <Columns>
            <asp:TemplateField HeaderText="Nhân viên">
                <ItemTemplate>
                    <asp:HyperLink ID="lnkNhanVien" runat="server"></asp:HyperLink>

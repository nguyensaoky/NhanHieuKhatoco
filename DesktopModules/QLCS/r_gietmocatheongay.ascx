<%@ Control Language="C#" AutoEventWireup="true" CodeFile="r_gietmocatheongay.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.r_gietmocatheongay" %>
...
<table>
    <tr><td><center><b>THỐNG KÊ GIẾT MỔ CÁ THEO NGÀY</b></center><br /></td></tr>
    <tr>
        <td>
            Từ ngày&nbsp;&nbsp;&nbsp;

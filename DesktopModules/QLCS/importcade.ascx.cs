...
{
    public partial class importcade : DotNetNuke.Entities.Modules.PortalModuleBase
    {
            ...
            try
            {
                ...
                foreach (DataRow r in dTable.Rows)
                {
                    ...
                    if (dtCa.Rows.Count == 1)
                    {
                        ...
                        if (r["KhayUm"].ToString() != "" && r["KhayUm"].ToString() != "221") tdd.KhayUm = Convert.ToInt32(r["KhayUm"]);
                        ...
                        string arrSoLuong = "";
                        if (Convert.ToInt32(r["ThaiLoai"]) > 0)
                        {
                            if (Convert.ToInt32(r["DiDang"]) > 0) { arrLyDoThaiLoaiTrung += "@1@"; arrSoLuong += "@" + Convert.ToInt32(r["DiDang"]).ToString() + "@"; }
                            if (Convert.ToInt32(r["ThieuCa"]) > 0) { arrLyDoThaiLoaiTrung += "@2@"; arrSoLuong += "@" + Convert.ToInt32(r["ThieuCa"]).ToString() + "@"; }
                            if (Convert.ToInt32(r["Nut"]) > 0) { arrLyDoThaiLoaiTrung += "@4@"; arrSoLuong += "@" + Convert.ToInt32(r["Nut"]).ToString() + "@"; }
                        }
                        else
                        {
                            arrSoLuong = "@0@";
                            arrLyDoThaiLoaiTrung = "@1@";
                        }

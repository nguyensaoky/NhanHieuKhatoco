<%@ Control Language="C#" AutoEventWireup="true" CodeFile="r_xuatnhapspgmtheoloai.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.r_xuatnhapspgmtheoloai" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<link href="<%= ModulePath + "style.css" %>" rel="stylesheet" type="text/css" />
<table>
    <tr><td><center><b>XUẤT NHẬP SẢN PHẨM GIẾT MỔ</b></center><br /></td></tr>
    <tr>
        <td>
            Từ ngày&nbsp;&nbsp;&nbsp;

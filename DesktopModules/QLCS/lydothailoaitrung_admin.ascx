<%@ Control Language="C#" AutoEventWireup="true" CodeFile="lydothailoaitrung_admin.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.lydothailoaitrung_admin" %>
...
<div align="left">
    ...
    <asp:HyperLink ID="lnkAddNew" runat="server" Text="Thêm lý do thải loại trứng" CssClass="button"></asp:HyperLink>
</div>
<div style="width:100%;">

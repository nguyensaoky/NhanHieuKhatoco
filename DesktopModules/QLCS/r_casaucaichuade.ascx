<%@ Control Language="C#" AutoEventWireup="true" CodeFile="r_casaucaichuade.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.r_casaucaichuade" %>
...
<table>
    <tr><td colspan="2"><center><b>DANH SÁCH CÁ SẤU CÁI CHƯA ĐẺ</b></center><br /></td></tr>
    <tr>
        <td>
            <span style="vertical-align:top;">Chưa đẻ trong năm</span>
            <asp:TextBox ID="txtYear" runat="server" Width="100" TabIndex="6" style="vertical-align:top;"/>&nbsp;
            <span style="vertical-align:top;">(Liệt kê từ năm&nbsp;</span><asp:TextBox ID="txtFromYear" runat="server" Width="100" TabIndex="6" style="vertical-align:top;"/><span style="vertical-align:top;">)</span>

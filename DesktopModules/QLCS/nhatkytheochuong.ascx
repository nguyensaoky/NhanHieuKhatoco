<%@ Control Language="C#" AutoEventWireup="true" CodeFile="nhatkytheochuong.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.nhatkytheochuong" %>
...
<table>
    <tr><td colspan="2"><center><b>NHẬT KÝ CHĂN NUÔI THEO CHUỒNG</b></center><br /></td></tr>
    <tr>
        ...
        <td valign="top" align="center">
            ...
            <asp:ListBox ID="lstChuong" runat="server" SelectionMode="Multiple" Rows="6" style="vertical-align:top;">
            </asp:ListBox>
        </td>
        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td valign="top" align="center">

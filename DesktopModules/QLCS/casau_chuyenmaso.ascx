<%@ Control Language="C#" AutoEventWireup="true" CodeFile="casau_chuyenmaso.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.casau_chuyenmaso" %>
...
<div id="wrapper" runat="server" class="wrapper_margin">
    <div style="width:200px;float:left;">Mã số mới</div>
    ...
    <asp:GridView ID="grvDanhSach" runat="server" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="NoteVal" HeaderText="Vi cắt mới" SortExpression="[NoteVal] DESC">
                <HeaderStyle ForeColor="Yellow"></HeaderStyle>
            </asp:BoundField>
            <asp:TemplateField>
                <HeaderTemplate>

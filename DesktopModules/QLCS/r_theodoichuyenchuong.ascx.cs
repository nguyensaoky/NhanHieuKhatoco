...
{
    public partial class r_theodoichuyenchuong : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string tieude = "";
                string strSQL = "QLCS_BCTK_NhatKy_Chuong_ChuyenChuong_TheoChuong_new";
                if (ddlChuan.SelectedValue == "1")
                {
                    strSQL = "QLCS_BCTK_NhatKy_Chuong_ChuyenChuong_TheoChuong_new_ChuanCu";
                }
                ...
                tieude += "<b>THEO DÕI BIẾN ĐỘNG Ô CHUỒNG - TỪ NGÀY " + txtTuNgay.Text + "  ĐẾN NGÀY " + txtDenNgay.Text + "</b>";

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="r_thuoctheongay.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.r_thuoctheongay" %>
...
<table>
    <tr><td><center><b>THUỐC THEO NGÀY</b></center><br /></td></tr>
    <tr>
        <td>
            ...
            <asp:ListBox ID="ddlThuoc" runat="server" SelectionMode="Multiple" AutoPostBack="false" Rows="4" ToolTip="Thuốc"></asp:ListBox>
            <asp:ListBox ID="lstKhuChuong" runat="server" SelectionMode="Multiple" Rows="6" style="vertical-align:top;" ToolTip="Khu chuồng">
            </asp:ListBox>
            <span style="vertical-align:top;">Số chữ số thập phân<asp:TextBox ID="txtScale" runat="server" Width="10">1</asp:TextBox>&nbsp;</span>
            <span style="vertical-align:top;">
                <asp:DropDownList ID="ddlOrderBy" runat="server">
                    ...
                    <asp:ListItem Value="Thuoc">Thuốc</asp:ListItem>
                </asp:DropDownList>
            </span>

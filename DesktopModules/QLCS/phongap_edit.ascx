<%@ Control Language="C#" AutoEventWireup="true" CodeFile="phongap_edit.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.phongap_edit" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<link href="<%= ModulePath + "style.css" %>" rel="stylesheet" type="text/css" />
<table>
    <tr>
        <td width="100">Phòng ấp</td>
        <td>
            <asp:TextBox ID="txtPhongAp" runat="server" style="width:400px;" TabIndex="2"/>
        </td>
    </tr>
    <tr>
        <td>Đang dùng</td>

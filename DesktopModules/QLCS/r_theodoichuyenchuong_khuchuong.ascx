<%@ Control Language="C#" AutoEventWireup="true" CodeFile="r_theodoichuyenchuong_khuchuong.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.r_theodoichuyenchuong_khuchuong" %>
...
<table>
    <tr><td colspan="2"><center><b>THEO DÕI CHUYỂN CHUỒNG - THEO KHU CHUỒNG</b></center><br /></td></tr>
    <tr>
...
<br /><br /><br />
<asp:Literal ID="ltt" runat="server" EnableViewState="false"></asp:Literal>
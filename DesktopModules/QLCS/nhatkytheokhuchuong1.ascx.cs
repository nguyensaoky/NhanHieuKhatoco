...
{
    public partial class nhatkytheokhuchuong1 : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            {
                System.Globalization.CultureInfo ci = System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN");
                string filename = "NKKC";
                string tieude = "";
                string strSQL = "QLCS_BCTK_NhatKy_TheoKhuChuong_1_new";
                if (ddlChuan.SelectedValue == "1")
                {
                    strSQL = "QLCS_BCTK_NhatKy_TheoKhuChuong_1_new_ChuanCu";
                }
                ...
                param[6] = new SqlParameter("@PhanLoai", int.Parse(ddlPhanLoai.SelectedValue));
                filename += txtTuNgay.Text + "__" + txtDenNgay.Text + ".xls";
                filename = filename.Replace("/", "_").Replace(" ", "");
                tieude += "<b>NHẬT KÝ CHĂN NUÔI KHU CHUỒNG " + Config.GetSelectedTexts(lstKhuChuong) + " - TỪ NGÀY " + txtTuNgay.Text + "  ĐẾN NGÀY " + txtDenNgay.Text + "</b>";
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                param[5] = new SqlParameter("@ScaleTTY", int.Parse(ddlScaleTTY.SelectedValue));
                param[6] = new SqlParameter("@PhanLoai", int.Parse(ddlPhanLoai.SelectedValue));
                tieude += "<b>NHẬT KÝ CHĂN NUÔI THEO KHU CHUỒNG - TỪ NGÀY " + txtTuNgay.Text + "  ĐẾN NGÀY " + txtDenNgay.Text + "</b>";

    ...
    public partial class r_biendongdan : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        ...
        protected void btnExcel_FromFirstOct_Click()
        {
            try
            {
                ...
                sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(GiaTri1[0, 5] - Convert.ToInt32(rTD["GietMo"]) + GiaTri1[0, 4] - Convert.ToInt32(rTD["LoaiThai"]), 0) + "</td><td></td><td>" + Config.ToXVal2(GiaTri1[0, 5] - Convert.ToInt32(rTD["GietMo"]) + GiaTri1[0, 4] - Convert.ToInt32(rTD["LoaiThai"]), 0) + "</td><td></td><td></td>");
                ...
                for (i = 1; i < 4; i++)
                {
                    ...
                    for (t = 0; t < 3; t++)
                    {
                        if (t == 0)
                        {
                            ...
                            sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(GiaTri[t, 5] + GiaTri[t, 4], 0) + "</td><td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(Convert.ToInt32(dtPLGM.Rows[i * 4 + 1]["GietMo"]) + Convert.ToInt32(dtPLGM.Rows[i * 4 + 3]["GietMo"]), 0) + "</td><td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(Convert.ToInt32(dtPLGM.Rows[i * 4]["GietMo"]) + Convert.ToInt32(dtPLGM.Rows[i * 4 + 2]["GietMo"]) + GiaTri[t, 4], 0) + "</td><td></td><td></td>");
                        ...
                        else
                        {
                            ...
                            sb.Append("<td style='text-align:right;'>" + Config.ToXVal2(GiaTri[t, 5] + GiaTri[t, 4], 0) + "</td><td style='text-align:right;'>" + Config.ToXVal2(dtPLGM.Rows[i * 4 + t * 2 - 1]["GietMo"], 0) + "</td><td style='text-align:right;'>" + Config.ToXVal2(Convert.ToInt32(dtPLGM.Rows[i * 4 + t * 2 - 2]["GietMo"]) + GiaTri[t, 4], 0) + "</td><td></td><td></td>");
                ...
                for (int n = 0; n < 1; n++)
                {
                    ...
                    for (t = 0; t < 3; t++)
                    {
                        if (t == 0)
                        {
                            ...
                            sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(GiaTri[t, 15] + GiaTri[t, 12], 0) + "</td>");
                            ...
                            sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(Convert.ToInt32(dtPLGM1.Rows[0]["GietMo"]) + Convert.ToInt32(dtPLGM1.Rows[2]["GietMo"]) + GiaTri[t, 12], 0) + "</td>");
                            sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(GiaTri[t, 16] + GiaTri[t, 13], 0) + "</td>");
                            sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(GiaTri[t, 17] + GiaTri[t, 14], 0) + "</td>");
                        ...
                        else
                        {
                            ...
                            sb.Append("<td style='text-align:right;'>" + Config.ToXVal2(GiaTri[t, 15] + GiaTri[t, 12], 0) + "</td>");
                            sb.Append("<td style='text-align:right;'>" + Config.ToXVal2(dtPLGM1.Rows[t * 2 - 1]["GietMo"], 0) + "</td>");
                            sb.Append("<td style='text-align:right;'>" + Config.ToXVal2(Convert.ToInt32(dtPLGM1.Rows[t * 2 - 2]["GietMo"]) + GiaTri[t, 12], 0) + "</td>");
                            sb.Append("<td style='text-align:right;'>" + Config.ToXVal2(GiaTri[t, 16] + GiaTri[t, 13], 0) + "</td>");
                            sb.Append("<td style='text-align:right;'>" + Config.ToXVal2(GiaTri[t, 17] + GiaTri[t, 14], 0) + "</td>");
                ...
                for (i = 4; i < 7; i++)
                {
                    ...
                    for (t = 0; t < 3; t++)
                    {
                        if (t == 0)
                        {
                            ...
                            sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(Convert.ToInt32(dtPLGM.Rows[i * 4]["GietMo"]) + Convert.ToInt32(dtPLGM.Rows[i * 4 + 2]["GietMo"]) + GiaTri[t, 12], 0) + "</td>");
                            sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(GiaTri[t, 16] + GiaTri[t, 13], 0) + "</td>");
                            sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(GiaTri[t, 17] + GiaTri[t, 14], 0) + "</td>");
                            sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(GiaTri[t, 18], 0) + "</td>");
                            sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(GiaTri[t, 19], 0) + "</td>");
                        ...
                        else
                        {
                            ...
                            sb.Append("<td style='text-align:right;'>" + Config.ToXVal2(Convert.ToInt32(dtPLGM.Rows[i * 4 + t * 2 - 2]["GietMo"]) + GiaTri[t, 12], 0) + "</td>");
                            sb.Append("<td style='text-align:right;'>" + Config.ToXVal2(GiaTri[t, 16] + GiaTri[t, 13], 0) + "</td>");
                            sb.Append("<td style='text-align:right;'>" + Config.ToXVal2(GiaTri[t, 17] + GiaTri[t, 14], 0) + "</td>");
                            sb.Append("<td style='text-align:right;'>" + Config.ToXVal2(GiaTri[t, 18], 0) + "</td>");
                            sb.Append("<td style='text-align:right;'>" + Config.ToXVal2(GiaTri[t, 19], 0) + "</td>");
                ...
                for (i = 7; i < 12; i++)
                {
                    ...
                    sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(GiaTri[15] + GiaTri[12], 0) + "</td><td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(dtPLGM.Rows[i * 4 + 1]["GietMo"], 0) + "</td><td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(Convert.ToInt32(dtPLGM.Rows[i * 4]["GietMo"]) + GiaTri[12], 0) + "</td><td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(GiaTri[16] + GiaTri[13], 0) + "</td><td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(GiaTri[17] + GiaTri[14], 0) + "</td>");
                ...
                sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(Tong[15] + Tong[12], 0) + "</td>");
                sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(TongPLGM[1], 0) + "</td>");
                sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(TongPLGM[0] + Tong[12], 0) + "</td>");
                sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(Tong[16] + Tong[13], 0) + "</td>");
                sb.Append("<td style='font-weight:bold;text-align:right;'>" + Config.ToXVal2(Tong[17] + Tong[14], 0) + "</td>");

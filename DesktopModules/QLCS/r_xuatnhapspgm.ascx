<%@ Control Language="C#" AutoEventWireup="true" CodeFile="r_xuatnhapspgm.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.r_xuatnhapspgm" %>
...
<table>
    <tr><td colspan="2"><center><b>XUẤT NHẬP SẢN PHẨM GIẾT MỔ THEO NGÀY</b></center><br /><asp:Label ID="lblMessage" runat="server" Text="" ForeColor="Red" Font-Bold="true"></asp:Label></td></tr>
    <tr>
        <td valign="top">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">
                        <span style="vertical-align:top;">Sắp xếp SPGM</span>
                    </td>
                </tr>
                <tr>
                    <td align="left">
        ...
        <td>
            <asp:ListBox ID="ddlSPGM" runat="server" SelectionMode="Multiple" AutoPostBack="false" Rows="6" ToolTip="SPGM"></asp:ListBox>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="casau_chuyenloaica.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.casau_chuyenloaica" %>
...
<div id="wrapper" runat="server" class="wrapper_margin">
    <div style="width:200px;float:left;">Loại cá mới</div>
    <asp:DropDownList runat="server" ID="ddlLoaiCa">
    </asp:DropDownList>
    <br />
    ...
    <asp:GridView ID="grvDanhSach" runat="server" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="NoteVal" HeaderText="Loại cá mới" SortExpression="[NoteVal] DESC">
                <HeaderStyle ForeColor="Yellow"></HeaderStyle>
            </asp:BoundField>
            <asp:TemplateField>
                <HeaderTemplate>

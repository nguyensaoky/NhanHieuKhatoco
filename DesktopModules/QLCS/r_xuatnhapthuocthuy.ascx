<%@ Control Language="C#" AutoEventWireup="true" CodeFile="r_xuatnhapthuocthuy.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.r_xuatnhapthuocthuy" %>
...
<table>
    <tr><td colspan="2"><center><b>XUẤT NHẬP THUỐC THÚ Y</b></center><br /><asp:Label ID="lblMessage" runat="server" Text="" ForeColor="Red" Font-Bold="true"></asp:Label></td></tr>
    <tr>
        <td valign="top">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">
                        <span style="vertical-align:top;">Sắp xếp thuốc</span>
                    </td>
                </tr>
                <tr>
                    <td align="left">
        ...
        <td>
            <asp:ListBox ID="ddlThuoc" runat="server" SelectionMode="Multiple" AutoPostBack="false" Rows="6" ToolTip="Thuốc thú y" style="float:left;margin-right:5px;"></asp:ListBox>
            <span style="vertical-align:top;">Số chữ số thập phân</span>
            <asp:TextBox ID="txtC" runat="server" Width="15" style="vertical-align:top;" Text="1"/><br /><br />

...
{
    public partial class r_theodoichuyenchuong_loaica : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string tieude = "";
                string strSQL = "QLCS_BCTK_NhatKy_Chuong_ChuyenChuong_TheoLoaiCa_new";
                if (ddlChuan.SelectedValue == "1")
                {
                    strSQL = "QLCS_BCTK_NhatKy_Chuong_ChuyenChuong_TheoLoaiCa_new_ChuanCu";
                }
                ...
                tieude += "<b>THEO DÕI BIẾN ĐỘNG Ô CHUỒNG THEO LOẠI CÁ " + Config.GetSelectedTexts(lstLoaiCa) + " - TỪ NGÀY " + txtTuNgay.Text + "  ĐẾN NGÀY " + txtDenNgay.Text + "</b>";
                ...
                if (ddlOrderBy.SelectedValue == "Ngay")
                {
                    ...
                    for (int j = 0; j < aLoaiCa.Length; j++)
                    {
                        ...
                        dt = ds.Tables[j];
                        sb.Append("<tr><td align='center'><b><span style='color:#f00;'>" + aLoaiCa[j] + "</span></b></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>");
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            if (currThoiDiem != Convert.ToDateTime(r["ThoiDiem"]) && currThoiDiem != DateTime.MinValue)
                            {
                                ...
                                TotalChet += TongChet; TotalLoaiThai += TongLoaiThai;
                            ...
                            int ch = r["Chet"] != DBNull.Value ? Convert.ToInt32(r["Chet"]) : 0; int lt = r["LoaiThai"] != DBNull.Value ? Convert.ToInt32(r["LoaiThai"]) : 0;
                        ...
                        if (currThoiDiem != DateTime.MinValue)
                        {
                            ...
                            SupTotalChet += TotalChet; SupTotalLoaiThai += TotalLoaiThai;
                            SupTotalGietMo += TotalGietMo;
                            SupTotalBan += TotalBan;
                        }
                    }
                    sb.Append("<tr style='color:#F00;font-weight:bold;'><td align='center'>TỔNG CÁC LOẠI CÁ</td><td></td><td></td><td align='right'>" + Config.ToXVal2(SupTotalChuyenDen, 0) + "</td><td></td><td align='right'>" + Config.ToXVal2(SupTotalChuyenDi, 0) + "</td><td></td><td align='right'>" + Config.ToXVal2(SupTotalChet, 0) + "</td><td align='right'>" + Config.ToXVal2(SupTotalLoaiThai, 0) + "</td><td align='right'>" + Config.ToXVal2(SupTotalGietMo, 0) + "</td><td align='right'>" + Config.ToXVal2(SupTotalBan, 0) + "</td><td></td></tr>");
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                param[3] = new SqlParameter("@OrderBy", ddlOrderBy.SelectedValue);
                param[4] = new SqlParameter("@PhanLoai", int.Parse(ddlPhanLoai.SelectedValue));
                tieude += "<b>THEO DÕI BIẾN ĐỘNG Ô CHUỒNG THEO LOẠI CÁ - TỪ NGÀY " + txtTuNgay.Text + "  ĐẾN NGÀY " + txtDenNgay.Text + "</b>";
                ...
                if (ddlOrderBy.SelectedValue == "Ngay")
                {
                    ...
                    {
                        DateTime currThoiDiem = DateTime.MinValue;
                        int TongSoChuong = 0; int TongSoCa = 0; decimal TongThucAn = 0; decimal TongBST = 0; int TongChuyenDen = 0; int TongChuyenDi = 0; int TongChet = 0; int TongLoaiThai = 0; int TongGietMo = 0; int TongBan = 0; int TongSoCaCK = 0;
                        int TotalChuyenDen = 0; int TotalChuyenDi = 0; int TotalChet = 0; int TotalLoaiThai = 0; int TotalGietMo = 0; int TotalBan = 0;
                        dt = ds.Tables[j];
                        sb.Append("<tr><td align='center'><b><span style='color:#f00;'>" + aLoaiCa[j] + "</span></b></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>");
                        for (int i = 0; i < dt.Rows.Count; i++)

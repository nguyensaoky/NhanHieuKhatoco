<%@ Control Language="C#" AutoEventWireup="true" CodeFile="phongap_admin.ascx.cs" Inherits="DotNetNuke.Modules.QLCS.phongap_admin" %>
...
<div align="left">
    ...
    <asp:HyperLink ID="lnkAddNew" runat="server" Text="Thêm phòng ấp mới" CssClass="button"></asp:HyperLink>
</div>
<div style="width:100%;">
    <asp:GridView ID="grvDanhSach" runat="server"
        ...
        Width="100%">
        <Columns>
            <asp:TemplateField HeaderText="Phòng ấp">
                <ItemTemplate>
                    <asp:HyperLink ID="lnkPhongAp" runat="server"></asp:HyperLink>

...
{
    public partial class news_list_settings : DotNetNuke.Entities.Modules.ModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                ...
                if (ModuleSettings["numShortNews"] != null) txtNumShortNews.Text = ModuleSettings["numShortNews"].ToString();
                ...
                if (ModuleSettings["displayPaging"] != null) chkDisplayPaging.Checked = bool.Parse(ModuleSettings["displayPaging"].ToString());
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                objModules.UpdateModuleSetting(ModuleId, "numShortNews", txtNumShortNews.Text);
                ...
                objModules.UpdateModuleSetting(ModuleId, "displayPaging", chkDisplayPaging.Checked.ToString());

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="news_list_slideshow_settings.ascx.cs" Inherits="DotNetNuke.News.news_list_slideshow_settings" %>
...
<table>
    ...
    <tr>
        <td><asp:Label ID="lblTimeOut" runat="server" resourcekey="lblTimeOut"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtTimeOut" runat="server">3000</asp:TextBox>&nbsp;ms
        </td>
    </tr>
    <tr>
        <td><asp:Label ID="lblDisplayHeadline" runat="server" resourcekey="lblDisplayHeadline"></asp:Label></td>
        <td>
            <asp:CheckBox ID="chkDisplayHeadline" runat="server" Checked="false"/>
        </td>
    </tr>
    <tr>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cat_menu_settings.ascx.cs" Inherits="DotNetNuke.News.cat_menu_settings" %>
<table width="100%">
    <tr>
        ...
        <td>
            <asp:RadioButtonList ID="lstRdSource" runat="server">
                ...
                <asp:ListItem resourcekey="itemViaParent" Value="2"></asp:ListItem>
            </asp:RadioButtonList>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><asp:label ID="lblParentCat" runat="server" resourcekey="lblParentCat"></asp:label></td>
        <td><asp:DropDownList ID="ddlParentCat" runat="server" /></td>
    </tr>
    <tr>
